  ...
  public:
    ...
    void operator()(ADvector& fg, const ADvector& x) {
      ...
      for (int i = 0; i < N - 1; ++i) {
        ...
        //cout << "py_desired "<< py_desired << " psi_desired " << psi_desired<<endl;
        //cout << "px0 "<< px0 << " py0 " << py0<< " psi0 " << psi0 <<endl;
        //cout << "px1_f "<< px1_f << " py1_f " << py1_f<< " psi1_f " << psi1_f << " cte1_f " <<cte1_f<< " epsi1_f "<<epsi1_f<< endl;
